...
public class CommandTestUtil {
    ...
    public static final String VALID_DESCRIPTION_AMY = "Blood Disorder";
    public static final String VALID_DESCRIPTION_BOB = "Blood Disorder";
    public static final String VALID_NOK_AMY = "Ben Bee";
    public static final String VALID_NOK_BOB = "Ben Bee";
    ...
    public static final String INVALID_TIME_DESC = " " + PREFIX_TIME + "Monday"; // Time must be in a specific format
    public static final String INVALID_HEADING_DESC = " " + PREFIX_HEADING + " "; // Time must be in a specific format
